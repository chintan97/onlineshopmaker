		...
		<!-- Main -->
			<section id="main" class="wrapper">
				...
				<div class="container">
					...
					<div align="center"><a href="templatechosen.php?temp=<?php echo $x;?>" class="button">Choose and Proceed</a>&nbsp;&nbsp;<a href="http://localhost/onlineshopmaker_localhost_3-master/templates/<?php echo $x;?>/main/index.html" class="button iframe" id="live demo">Live Demo</a></div>
				</div>
