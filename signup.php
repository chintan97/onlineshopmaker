			...
			<header id="header">
				...
				<nav id="nav">
					<ul>
						...
						<li><a href="login.php" class="button special">Sign Up/In</a></li>
					</ul>
				</nav>
			</header>
			<br><br>
			<h2 style='color:#858585;' align='center'>Registration Form</h2>
			<section>
				<?php
					if(isset($_GET["errorcontentsame"])){
						echo "<h2 align=center style='color:#FF0000;'>Choose Different User name Or Email Or Mobile NO</h2>";
					}
				?>
				...
				<form method="post" name='signup' action="userdb.php">
					...
					<div align='center'>
						<div class="9u 12u$(4)">
							<table>
							<tr><td>First Name</td><td><input type="text" name="fname" id="fname"  placeholder="Name" required /></td></tr>
							<tr><td>Last Name</td><td><input type="text" name="lname" id="lname"  placeholder="Last Name" required/></td></tr>
							...
							<tr><td>Confirm Password</td><td><input type="password" name="cpwd" id="cpwd"  placeholder="Confirm Password" required/></td></tr>
							...
							<tr><td>Phone Number</td><td><input type="text" name="mob" id="mob"  placeholder="Phone Number" required/></td></tr>
							
							</table>
						</div>
						<div class="12u$">
							<ul class="actions">
								<li><input type="button" value="Submit" class="special" onClick="check_data();"/></li>
