...
function fillCategory(){ 
 ...
 for (var i=0; i<main.length; i++){
 	addOption(document.drop_list.Category, main[i], main[i], "");
 }
}
...
if(document.drop_list.Category.value == 'electronics'){
...
if(document.drop_list.Category.value == 'books'){
...
if(document.drop_list.Category.value == 'fitness'){
