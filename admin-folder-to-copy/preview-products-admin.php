...
<html lang="en">
	...
	<script>
		function showResult(str) {
		  ...
		  xmlhttp.open("GET","search_product-admin.php?q="+str,true);
		  xmlhttp.send();
		}
		...
		function showResult_cat(choice,str) {
		  ...
		  xmlhttp.open("GET","search_product-admin.php?q="+str+"&c="+choice,true);
		  xmlhttp.send();
		}
		...
		function showResult_subcat(choice,sub_choice,str) {
		  ...
		  xmlhttp.open("GET","search_product-admin.php?q="+str+"&c="+choice+"&s="+sub_choice,true);
		  xmlhttp.send();
		}
										...
										foreach ($data_to_show as $key => $value) {
											if ($key != "product_image")
												...
												?>
													...
													<br><img alt="Image could not be loaded" width="200" height="300" src="<?php echo '../images/'.$value[$j]; ?>" border="5"/>
													</div>
												<?php
												}
											}
