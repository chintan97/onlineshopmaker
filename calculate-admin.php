<?php
	...
	// new orders checking
	if (file_exists('user_folders/'.$username.'/orders.json')){
		$order_file = file_get_contents('user_folders/'.$username.'/orders.json');
	...
	if (file_exists('user_folders/'.$username.'/user_folder/user_data.json') && filesize('user_folders/'.$username.'/user_folder/user_data.json') > 0){
		$customer_file = file_get_contents('user_folders/'.$username.'/user_folder/user_data.json');
	...
	if (file_exists('user_folders/'.$username.'/order_summary.json')){
		$order_summary_file = file_get_contents('user_folders/'.$username.'/order_summary.json');
